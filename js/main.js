...
// create a Handlebars template is to get the HTML markup contained within the templateElement
const templateSource = templateElement.innerHTML;

// compile a template using the Handlebars.compile() method
const template = Handlebars.compile(templateSource);

// After calling Handlebars.compile() with an argument,
// a function is returned to the template.
// template will accept an object and use the properties of the object to fill in a Handlebars template
const compiledHtml = template(context);

// render the compiled HTML in the browser
